...
CREATE POLICY "Users can update own profile"
  ...
  TO authenticated
  USING (auth.uid() = user_profiles.id)
  WITH CHECK (auth.uid() = user_profiles.id);
...
CREATE POLICY "Users can create rooms"
  ...
  TO authenticated
  WITH CHECK (auth.uid() = chat_rooms.created_by);
...
CREATE POLICY "Users can join rooms"
  ...
  TO authenticated
  WITH CHECK (auth.uid() = chat_participants.user_id);
...
CREATE POLICY "Users can update own messages"
  ...
  TO authenticated
  USING (auth.uid() = chat_messages.user_id)
  WITH CHECK (auth.uid() = chat_messages.user_id);
...
CREATE POLICY "Users can manage own reactions"
  ...
  TO authenticated
  USING (auth.uid() = message_reactions.user_id)
  WITH CHECK (auth.uid() = message_reactions.user_id);
