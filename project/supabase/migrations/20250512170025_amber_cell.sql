...
CREATE POLICY "Users can create rooms"
  ...
  TO authenticated
  WITH CHECK (chat_rooms.created_by = auth.uid());
...
CREATE POLICY "Users can join rooms"
  ...
  TO authenticated
  WITH CHECK (chat_participants.user_id = auth.uid());
...
CREATE POLICY "Users can update own messages"
  ...
  WITH CHECK (chat_messages.user_id = auth.uid());
...
CREATE POLICY "Users can manage own reactions"
  ...
  WITH CHECK (message_reactions.user_id = auth.uid());